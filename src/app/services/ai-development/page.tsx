        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            {[
              ...
              <motion.div
                key={step.title}
                initial={{ opacity: 0, x: step.title === 'Requirements Analysis' ? -50 : step.title === 'Model Design & Development' ? 0 : step.title === 'Testing & Validation' ? -50 : 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.1 }}
                className={`relative mb-12 ${step.title === 'Requirements Analysis' ? 'pr-1/2' : step.title === 'Model Design & Development' ? 'pl-1/2' : step.title === 'Testing & Validation' ? 'pr-1/2' : 'pl-1/2'}`}
              >
                <div className={`flex ${step.title === 'Requirements Analysis' ? 'justify-end' : step.title === 'Model Design & Development' ? 'justify-start' : step.title === 'Testing & Validation' ? 'justify-end' : 'justify-start'}`}>
