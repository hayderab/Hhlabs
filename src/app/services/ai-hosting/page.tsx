        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            {[
              ...
              <motion.div
                key={step.title}
                initial={{ opacity: 0, x: step.title === 'Infrastructure Assessment' ? -50 : step.title === 'Architecture Design' ? 0 : step.title === 'Implementation' ? 50 : 0 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5, delay: 0.1 }}
                className={`relative mb-12 ${step.title === 'Infrastructure Assessment' ? 'pr-1/2' : step.title === 'Architecture Design' ? 'pl-1/2' : ''}`}
              >
                <div className={`flex ${step.title === 'Infrastructure Assessment' ? 'justify-end' : step.title === 'Architecture Design' ? 'justify-start' : ''}`}>
